...
python scripts/create_batch_jobs.py $CONFIG_FILE $BATCH_SIZE
...
NUM_BATCHES=$(ls configs/batches/batch_*_$(basename $CONFIG_FILE .yaml).yaml 2>/dev/null | wc -l)
...
echo "  python scripts/create_global_index_post_batch.py $CONFIG_FILE"